...
def get_kandinsky2_0(
    ...
    os.makedirs(cache_dir_text_en1, exist_ok=True)
    ...
    for name in [
        ...
        target_path = os.path.join(cache_dir_text_en1, name)
        shutil.copy2(downloaded_file, target_path)

    cache_dir_text_en2 = os.path.join(cache_dir, "text_encoder2")
    os.makedirs(cache_dir_text_en2, exist_ok=True)
    ...
    for name in [
        ...
        # Move file to correct location
        target_path = os.path.join(cache_dir_text_en2, name)
        shutil.copy2(downloaded_file, target_path)
